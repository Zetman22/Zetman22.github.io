...
I am a Ph.D. student in Computer Science at the University of Maryland, College Park, advised by [Prof. Ming C. Lin](https://www.cs.umd.edu/people/lin) and [Prof. Dinesh Manocha](https://www.cs.umd.edu/people/dmanocha). I am a member of [GAMMA Lab](https://gamma.umd.edu/), where I work on grounded auditory intelligence for long-horizon spoken interaction. My research focuses on building online audio-language agents that can maintain and revise an evidence-grounded belief state under partial observation, as semantic, speaker, paralinguistic, and temporal evidence is revealed incrementally, and use its uncertainty to decide when to continue listening, clarify, defer, or act.
